...
gulp.task('html', function(){
  return gulp.src('demo/dev_index.html')
  .pipe(replace('/dist/', '/watch/dist/'))
  .pipe(replace('/demo/', '/watch/demo/'))
  .pipe(rename({
      basename: 'index'
    }))
  .pipe(gulp.dest('demo'));
...
gulp.task('watch', [
  ...
  gulp.watch('demo/dev_index.html', browserSync.reload);
  gulp.watch('demo/dev_index.html', ['html']);
